...
public class TuijianAdapter extends BaseAdapter{
    ...
    private final List<TuijianBean.ListBean> datas;
    ...
    public TuijianAdapter(Context context, List<TuijianBean.ListBean> datas) {
    ...
    public int getItemViewType(int position) {
        int itemViewType = -1;
        //根据位置，从列表中得到一个数据对象
        TuijianBean.ListBean listBean = datas.get(position);
    ...
    @Override
    public TuijianBean.ListBean getItem(int position) {
    ...
    private View initView(View convertView, int itemViewType, TuijianBean.ListBean mediaItem) {
        switch (itemViewType) {
    ...
    class GifHolder extends BaseViewHolder{
        ...
        GifHolder(View convertView) {
            ...
            imageOptions = new ImageOptions.Builder()
                    ...
                    .setLoadingDrawableId(R.drawable.icon3)
                    .setFailureDrawableId(R.drawable.icon3)
                    .build();
